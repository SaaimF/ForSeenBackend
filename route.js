...
//UserEntryEff
const UserEntryRoute = require("./server/UserEntryEff/UserEntryEff.route");
route.use("/user-entryeff", UserEntryRoute);

//UserAvatar
const UserAvatarRoute = require("./server/UserAvatar/UserAvatar.route");
route.use("/user-avatar", UserAvatarRoute);

//UserTheme
const UserThemeRoute = require("./server/UserTheme/UserTheme.route");
route.use("/user-theme", UserThemeRoute);

//avatar route
const AvatarRoute = require("./server/avatar/avatar.route");
...
//privacy route
const PricacyRoute = require("./server/privacy/privacy.route");
route.use("/privacy", PricacyRoute);
